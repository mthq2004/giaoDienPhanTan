...
public class NhanVien extends JPanel {
    ...
    public NhanVien() {
        ...
        add(btnThemNhanVien);
        btnThemNhanVien.addActionListener(e -> {
            // Mở cửa sổ Thêm sản phẩm dưới dạng JDialog
            FormThemNhanVien form = new FormThemNhanVien((Frame) SwingUtilities.getWindowAncestor(this)); // Truyền cửa sổ cha
        ...
        String[] colNames = {
            ...
            "Chức vụ", "Lương", "Giới tính", "Trình độ",
            "Ngày sinh", "Ngày vào làm", "CCCD"
        };
